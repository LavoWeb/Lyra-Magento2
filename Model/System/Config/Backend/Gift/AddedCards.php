 ...
 */
namespace Lyranetwork\Lyra\Model\System\Config\Backend\Gift;

use Magento\Framework\App\Filesystem\DirectoryList;

class AddedCards extends \Lyranetwork\Lyra\Model\System\Config\Backend\Serialized\ArraySerialized\ConfigArraySerialized
{
    ...
    public function beforeSave()
    {
        ...
        foreach ($value as $key => $card) {
            ...
            $uploadDir = $this->filesystem->getDirectoryWrite(DirectoryList::MEDIA)->getAbsolutePath('lyra/images/cc/');
