...
if (! class_exists('LyraResponse', false)) {
    ...
    class LyraResponse
    {
        ...
        /**
         * Constructor for LyraResponse class.
         ...
         * @param string $algo
         */
        public function __construct($params, $ctx_mode, $key_test, $key_prod, $algo = LyraApi::ALGO_SHA1)
        {
            $this->rawResponse = LyraApi::uncharm($params);
        ...
        {
            return LyraApi::sign($this->rawResponse, $this->certificate, $this->algo, $hashed);
        }
        ...
        {
            $currency = LyraApi::findCurrencyByNumCode($this->get('currency'));
        ...
        public function getOutputForGateway($case = '', $extra_message = '', $original_encoding = 'UTF-8')
        {
            ...
            $encoding = in_array(strtoupper($original_encoding), LyraApi::$SUPPORTED_ENCODINGS) ?
