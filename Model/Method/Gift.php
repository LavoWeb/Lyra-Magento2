...
class Gift extends Lyra
{
    ...
    protected $_code = \Lyranetwork\Lyra\Helper\Data::METHOD_GIFT;
    protected $_formBlockType = \Lyranetwork\Lyra\Block\Payment\Form\Gift::class;
    ...
    public function assignData(\Magento\Framework\DataObject $data)
    {
        ...
        $info->setCcType($lyraData->getData('lyra_gift_cc_type'));
