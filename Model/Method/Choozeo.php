...
use Lyranetwork\Lyra\Model\System\Config\Source\ChoozeoCountry;

class Choozeo extends Lyra
{

    protected $_code = \Lyranetwork\Lyra\Helper\Data::METHOD_CHOOZEO;
    protected $_formBlockType = \Lyranetwork\Lyra\Block\Payment\Form\Choozeo::class;
    ...
    protected function setExtraFields($order)
    {
        ...
        $this->lyraRequest->set('validation_mode', '0');
        $this->lyraRequest->set('cust_status', 'PRIVATE');
        $this->lyraRequest->set('cust_country', 'FR');
    ...
    public function assignData(\Magento\Framework\DataObject $data)
    {
        ...
        $option = $lyraData->getData('lyra_choozeo_option');
        $info->setCcType($option)->setAdditionalInformation(\Lyranetwork\Lyra\Helper\Payment::CHOOZEO_OPTION, $option);
