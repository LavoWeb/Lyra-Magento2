...
class Fullcb extends Lyra
{
    ...
    protected $_code = \Lyranetwork\Lyra\Helper\Data::METHOD_FULLCB;
    protected $_formBlockType = \Lyranetwork\Lyra\Block\Payment\Form\Fullcb::class;
    ...
    protected function setExtraFields($order)
    {
        ...
        $this->lyraRequest->set('capture_delay', '0');
        ...
        if ($info->getCcType()) {
            ...
            $this->lyraRequest->set('payment_cards', 'FULLCB3X;FULLCB4X');
        }
    }
    ...
    public function assignData(\Magento\Framework\DataObject $data)
    {
        ...
        $option = $lyraData->getData('lyra_fullcb_option');
        if ($option) {
            $info->setCcType($option)->setAdditionalInformation(\Lyranetwork\Lyra\Helper\Payment::FULLCB_OPTION, $option);
        }
