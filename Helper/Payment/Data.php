 ...
 */
namespace Lyranetwork\Lyra\Helper\Payment;
...
class Data extends \Magento\Payment\Helper\Data
{
    ...
    public function getPaymentMethods()
    {
        ...
        $lyraMultiTitle = $methods['lyra_multi']['title']; // Get multi payment general title.
        unset($methods['lyra_multi']);
        ...
        foreach ($this->dataHelper->getMultiPaymentModelConfig() as $config) {
            ...
            $count = substr($code, strlen('lyra_multi_'));

            $methods[$code] = [
                'model' => $config['value'],
                'title' => $lyraMultiTitle . " ($count)",
                'group' => 'lyra'
            ];
        }
