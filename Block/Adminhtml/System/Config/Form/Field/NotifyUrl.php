...
class NotifyUrl extends Label
{
    ...
    /**
     *
     * @param \Lyranetwork\Lyra\Block\Adminhtml\System\Config\Form\Field\Context $context
     * @param array $data
     */
    public function __construct(
        \Lyranetwork\Lyra\Block\Adminhtml\System\Config\Form\Field\Context $context,
        array $data = []
    ) {
    ...
    public function render(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $warnImg = $this->getViewFileUrl('Lyranetwork_Lyra::images/warn.png');
