 ...
 */
namespace Lyranetwork\Lyra\Block\Payment\Iframe;
...
class Response extends \Magento\Framework\View\Element\Template
{
     ...
     * @param string $path
     * @param string $params
     * @return \Lyranetwork\Lyra\Block\Payment\Iframe\Response
     */
    ...
    public function getLoaderHtml()
    {
        $block = $this->getLayout()
            ...
            ->setTemplate('Lyranetwork_Lyra::payment/iframe/loader.phtml');
