 ...
 */
namespace Lyranetwork\Lyra\Setup;
    ...
    public function upgrade(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (version_compare($context->getVersion(), '2.4.0', '<')) {
            ...
            $select = $connection->select()
                ...
                ->where('status = ?', 'lyra_pending_transfer');
        ...
        if (version_compare($context->getVersion(), '2.4.1', '<')) {
            ...
            $customerSetup->addAttribute(
                Customer::ENTITY,
                'lyra_sepa_identifier',
                [
                    'type' => 'varchar',
                    'input' => 'text',
                    'label' => 'Lyra Collect SEPA identifier',
            ...
            $customerSetup->addAttribute(
                ...
                [
                    'type' => 'varchar',
                    'input' => 'text',
                    'label' => 'Lyra Collect SEPA IBAN/BIC',
