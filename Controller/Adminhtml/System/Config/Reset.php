 ...
 */
namespace Lyranetwork\Lyra\Controller\Adminhtml\System\Config;
...
class Reset extends \Magento\Backend\App\AbstractAction
{
    ...
    public function execute()
    {
        ...
        $where = [];
        $where[] = $connection->quoteInto('path REGEXP ?', '^payment/lyra_[a-z0-9]+/[a-z0-9_]+$');
        $where[] = $connection->quoteInto('path REGEXP ?', '^lyra/general/[a-z0-9_]+$');
        ...
        $this->messageManager->addSuccess(
            __('The configuration of the Lyra Collect module has been successfully reset.')
        );
